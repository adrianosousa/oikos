...
export interface IPCRequest {
    ...
    payload: PaymentProposal | SwapProposal | BridgeProposal | YieldProposal | FeedbackProposal | RGBIssueProposal | RGBTransferProposal | BalanceQuery | AddressQuery | Record<string, unknown> | AuditQuery | IdentityRegisterRequest | IdentitySetWalletRequest | ReputationQuery;
}
